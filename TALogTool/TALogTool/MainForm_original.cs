...
namespace TALogTool
{
	...
	public partial class MainForm : Form
	{
		...
		void CfgBtnClick(object sender, EventArgs e)
		{
			if(patternList == null)
...
//          MessageBox.Show("Total time is "+tsDuration.TotalSeconds.ToString()); 
		}
...
//			MessageBox.Show(tmpLS.Count.ToString());
		...
		private void AnalyzeLogs()
		{
			...
			//mi = type.GetMethod("GetPatientsById");
